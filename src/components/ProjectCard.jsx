...
export default function ProjectCard({project}){
  return (
    <motion.div whileHover={{y:-4}} transition={{type:'spring',stiffness:300,damping:20}} className="p-6 bg-white rounded-lg shadow hover:shadow-xl transition">
      {project.image && (
      ...
      <div className="flex items-center gap-4">
        ...
        {project.repo && (
          <a href={project.repo} className="text-sm text-gray-500">Repo</a>
        )}
      </div>
    </motion.div>
  )
